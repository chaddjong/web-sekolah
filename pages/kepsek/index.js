          ...
          <div className="col-md-10">
            <div className="row">
              <div className="col-md-6">
                <h1 style={{ color: "violet", fontFamily: "cursive" }} className="text-center fw-bold mt-2 border-bottom border-info shadow-sm">
                  Dashboard
                </h1>
                <p
                  style={{
                  ...
                  className="mt-3"
                >
                  Selamat datang , Anda bisa memvalidasi Nilai Rapor dan melihat hasil PPDB loh... dengan cara menekan menu di bagian kiri layar
                </p>
              </div>
              <div className="col-md-6">
                {" "}
